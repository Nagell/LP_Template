...
<head>
    ...
    <script type="text/javascript">
        function showCheckbox() {
            var regex = new RegExp("[\\?&]gCheckbox=([^&#]*)");
            var results = regex.exec(window.location.href);
            if (results) {
                var checkBoxEnabled = results[0].split("=")[1];

                var gCheckBox = document.getElementById("googleCheckboxDiv");

                if (checkBoxEnabled == "true" || checkBoxEnabled == true) {
                    gCheckBox.style.display = "block";
                    document.getElementById("googleCheckbox").checked = false;
                }
            }
        }
    </script>
...
<body class="mwdkbody" onload="showCheckbox()">
                            ...
                            <div class="legal">
                                ...
                                <form action="" method="POST">
                                    <div class="msisdnInput">
                                        <label for="msisdnInput">Bitte Handynummer eingeben:</label>
                                        <input type="tel" class="mwdkInput input" id="msisdnInput" placeholder="Handynummer" />
                                    </div>

                                    <div id="googleCheckboxDiv" style="display: none;" class="msisdnInput">
                                        <input type="checkbox" id="googleCheckbox" checked="checked" />Der Preis
                                        f&uuml;r das Abo betr&auml;gt X,XX Euro pro 7 Tage.
                                    </div>

                                    <div class="aboContainer ">
                                        Abgerechnet wird &uuml;ber Ihre an den Anbieter &uuml;bermittelte Handynummer. Preis f&uuml;r das Abo: X,XX Euro pro 7 Tage. Das "Product" Abo ist jederzeit &uuml;ber den Kundenservice 0800 1234 567 (kostenlos) k&uuml;ndbar.
                                    </div>
                                    ...
                                    <div class="buyButton">
                                        <div class="formContainer">
                                            <div class="btnContainer">
                                                <div>
                                                    <button type="submit" class="button " id="kaufenBtn">
                                                        <span>Weiter</span>
                                                    </button>
                                                </div>
                                            </div>
